...
(function () {
    ...
    RemoteImage.prototype = {
        ...
        setPreview: function(){
            ...
            if(url) {
                preview.innerHTML = '<img src="../../../utf8-php/dialogs/image/' + url + '" width="' + width + '" height="' + height + '" border="' + border + 'px solid #000" title="' + title + '" />';
            }
        },
                    ...
                    if (browser.ie && browser.version <= 7) {
                        ...
                        uploader.makeThumb(file, function (error, src) {
                            if (error || !src) {
                                ...
                                var $img = $('<img src="../../../utf8-php/dialogs/image/' + src + '">');
